...
-Change geolocator to get US states/KR provinces without losing accuracy. How?
-Spell out country names once the geolocator is updated
...
$(document).ready(function() {
  var lat, lon;
  //Geolocator based on IP address (HTML geolocator asks permission, which is great for privacy but annoying)

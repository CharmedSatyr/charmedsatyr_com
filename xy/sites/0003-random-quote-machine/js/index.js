...
var list = {
  ...
  63: {
    quotation: "What feeling feels like over time. An attempt to screw up what feeling feels like over time. Heartbreak and a high C.... The often welcome melodic lie.... The soul's undersong. The orchestration of randomness, a flirtation with the boundaries of silence and space.... a reminder that the self wants to disappear, be taken away from itself and returned.",
    author: "Stephen Dunn"
  },
  64: {
    quotation: "Musical compositions, it should be remembered, do not inhabit certain countries, certain museums, like paintings and statues. The Mozart Quintet is not shut up in Salzburg: I have it in my pocket.",
    author: "Henri Rabaud"
  },
  65: {
  ...
  78: {
    quotation: "Here's to the crazy ones. The misfits. The rebels. The troublemakers. The round pegs in the square holes. The ones who see things differently. They're not fond of rules. And they have no respect for the status quo. You can quote them, disagree with them, glorify or vilify them. About the only thing you can't do is ignore them. Because they change things. They push the human race forward. And while some may see them as the crazy ones, we see genius. Because the people who are crazy enough to think they can change the world, are the ones who do.",
    author: "Rob Siltanen"
  },
  79: {
